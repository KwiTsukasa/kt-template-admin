...
vi.mock('#/api/message-management/subscribers/bot', () => ({
  createBotMessageBinding: mocks.api.create,
  updateBotMessageBinding: mocks.api.update,
}));

vi.mock(
  '@test-source/apps/web-antdv-next/src/views/bot/account/components/MessagePushTargetPicker',
  () => ({
...
describe('bot message subscriber modal', () => {
  ...
  it('offers only Bot subscriptions and contains no private template field', () => {
