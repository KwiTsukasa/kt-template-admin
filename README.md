...
- 顶级“媒体治理”默认进入系列资料库，目录固定为 `Series → Work → Season/Episode → Task`。Series 创建同时建立主 Work；只有 TV Work 创建 Season/Episode，电影和剧场版保持无伪季独立 Work。全局 Task 页只读，来源、逐文件映射、下载、目录/文件名归一化和机械验收按 revision 执行。
