...
export default defineComponent({
  ...
  setup(props, { attrs, slots }) {
    ...
    /**
     * 根据表头边界创建列宽拖拽参考线；拖动期间不重排表格本体。
     *
     * @param headerCell - 被拖拽列的表头元素；为空时无法创建参考线。
     */
    ...
    /**
     * 根据鼠标水平位移计算受最小宽度限制的新列宽，并移动参考线。
     *
     * @param event - 拖动过程中提供最新水平坐标的全局鼠标事件。
     */
     ...
     * 处理鼠标释放，结束当前列宽拖拽。
     *
     * @param event - 结束拖拽并传给列宽回调的鼠标释放事件。
     */
    ...
    /**
     * 在非拖拽点击时把鼠标事件转交给原表头点击处理器。
     *
     * @param event - 需要转交给原表头处理器的点击事件。
     */
     ...
     *
     * @param event - 表头收到、可能因刚结束拖拽而被拦截的点击事件。
     */
