...
export namespace PluginPlatformTaskApi {
 ...
 */
export function getPluginTaskPage(params: PluginPlatformTaskApi.TaskQuery) {
  return requestClient.get<
    PluginPlatformTaskApi.PageResult<PluginPlatformTaskApi.Task>
  >('/plugin-platform/tasks/page', { params });
}
 ...
 */
export function enablePluginTask(id: string) {
  return requestClient.post<PluginPlatformTaskApi.Task>(
    `/plugin-platform/tasks/${id}/enable`,
  );
}
 ...
 */
export function disablePluginTask(id: string) {
  return requestClient.post<PluginPlatformTaskApi.Task>(
    `/plugin-platform/tasks/${id}/disable`,
  );
}
 ...
 */
export function updatePluginTaskCron(id: string, cronExpression: string) {
  return requestClient.post<PluginPlatformTaskApi.Task>(
    `/plugin-platform/tasks/${id}/cron`,
    { cronExpression },
  );
}
 ...
 */
export function runPluginTaskOnce(id: string, input: Recordable<any> = {}) {
  return requestClient.post<{ jobId: string; taskId: string }>(
    `/plugin-platform/tasks/${id}/run`,
    { input },
  );
}
 ...
 */
export function getPluginTaskRunPage(
  id: string,
  params: PluginPlatformTaskApi.TaskRunQuery,
) {
  return requestClient.get<
    PluginPlatformTaskApi.PageResult<PluginPlatformTaskApi.TaskRun>
  >(`/plugin-platform/tasks/${id}/runs`, { params });
}
