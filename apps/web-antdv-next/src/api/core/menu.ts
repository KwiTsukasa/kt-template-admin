...
const SUPPORTED_ADMIN_MENU_NAMES = new Set([
  ...
  'AutomationFormDesigner',
  'AutomationFormEdit',
  'AutomationFormPreview',
  'AutomationFormPublish',
  'AutomationForms',
  'AutomationFormTest',
  'AutomationFormVersions',
  'AutomationRuleDesigner',
  'AutomationRuleEdit',
  'AutomationRulePublish',
  'AutomationRules',
  'AutomationRuleTest',
  'AutomationRuleVersions',
  'AutomationScheduleControl',
  'AutomationScheduleDesigner',
  'AutomationScheduleEdit',
  'AutomationScheduleEnable',
  'AutomationSchedulePublish',
  ...
  'AutomationTriggerEdit',
  'AutomationTriggerPublish',
  'AutomationTriggers',
  'AutomationTriggerTest',
  'AutomationTriggerVersions',
  'AutomationWorkflowCancel',
  'AutomationWorkflowDebugger',
