...
/**
 * 将 Bot 状态码映射为中文标签，未知非空状态保留原文，空值按未知展示。
 *
 * @param status - Bot 运行或配置状态；空值显示未知，未收录状态保留原文本。
...
/**
 * 根据 Bot 在线、失败、漂移、冷却和等待状态选择语义颜色。
 *
 * @param status - Bot 运行或配置状态；未收录状态使用默认标签色。
 * @returns 适用于当前状态的根据 Bot 在线、失败、漂移、冷却和等待状态选择语义颜色。
 */
