...
export default defineComponent({
  ...
  setup() {
    ...
    const renderFloatingCard = () => {
      return (
        <div class="bot-napcat-webui__floating-card">
          <div class="bot-napcat-webui__floating-head">
            <span class="bot-napcat-webui__floating-title">
              {accountTitle.value}
            </span>
            <ATag color={statusMeta.value.color}>{statusMeta.value.label}</ATag>
          </div>
          <div class="bot-napcat-webui__floating-meta">
          ...
          <ASpace class="bot-napcat-webui__floating-actions" size={6}>
            <AButton onClick={goBack} size="small" type="text">
              <ArrowLeft class="bot-napcat-webui__back-icon" />
              返回
            </AButton>
            <AButton
    ...
    const renderBody = () => {
      if (session.state.value === 'ready' && session.iframeUrl.value) {
        return (
          <div class="bot-napcat-webui__iframe-shell">
            <iframe
              class="bot-napcat-webui__iframe"
      ...
      if (
        ...
        return (
          <div class="bot-napcat-webui__message">
            <AAlert
              showIcon
              title={(() => {
      ...
      return (
        <div class="bot-napcat-webui__center">
    ...
    const renderPage = () => {
      return (
        <div class="bot-napcat-webui-page">
          <div class="bot-napcat-webui">
            <div class="bot-napcat-webui__content">{renderBody()}</div>
            {renderFloatingCard()}
          </div>
        </div>
      );
